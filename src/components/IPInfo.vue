<template>
  ...
  >
    ...
    <div class="flex flex-col">
      <h3 class="text-xs text-center mb-2 uppercase">IP Address</h3>
      <span class="text-2xl">{{ ipInfo.address }}</span>
    </div>
    <!-- Flex Item #2 -->
    <div class="flex flex-col">
      <h3 class="text-xs text-center mb-2 uppercase">Location</h3>
      <span class="text-2xl">{{ ipInfo.state }}</span>
    </div>
    <!-- Flex Item #3 -->
    <div class="flex flex-col">
      <h3 class="text-xs text-center mb-2 uppercase">Timezone</h3>
      <span class="text-2xl">UTC {{ ipInfo.timezone }}</span>
    </div>
    <!-- Flex Item #4 -->
    <div class="flex flex-col">
      <h3 class="text-xs text-center mb-2 uppercase">ISP</h3>
